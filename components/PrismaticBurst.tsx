...
const PrismaticBurst = ({
  ...
  useEffect(() => {
    ...
    onCanvasReady?.(gl.canvas as HTMLCanvasElement);
  ...
  return (
    <div className="w-full h-full relative overflow-hidden" ref={containerRef}>
      <div className="absolute inset-0 pointer-events-none z-10 [background:radial-gradient(ellipse_at_center,transparent_0%,hsl(var(--background))_100%)]" />
    </div>
  );
};
