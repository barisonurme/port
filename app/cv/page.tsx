      ...
      <div className="cv-sheet mx-auto max-w-6xl px-10 sm:px-16 pt-28 pb-28">
        ...
        <div className="cv-no-print cv-reveal mt-20 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          ...
          <button
            ...
            className="rounded-full group relative flex items-center gap-3 overflow-hidden border border-white/20 hover:border-white/50 px-8 py-4 text-sm uppercase tracking-widest text-white/50 hover:text-zinc-950 transition-colors duration-500 cursor-pointer"
          >
